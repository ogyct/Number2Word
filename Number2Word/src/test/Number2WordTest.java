...
//    }
    ...
    public void testNumber2CzechWordInteger() {
        System.out.println(number2CzechWord("123,23", 0, true, false, Currency.CROWNS));
        System.out.println(number2CzechWord("123", 0, true, false, Currency.INTEGER));
        System.out.println(number2CzechWord("12", 0, true, false, Currency.INTEGER));
        System.out.println(number2CzechWord("4", 0, true, false, Currency.INTEGER));
        System.out.println(number2CzechWord("123456789", 0, true, false, Currency.INTEGER));
        System.out.println("------------");
    }
